...
export default class membersViewGroup extends Component {
  ...
  goToMemberDetail(data) {
    ...
    this.props.navigation.navigate("memberViewDetail", { group_id: this.state.group_id , member_id: member_id, name: member_name, onNavigateBack: this.handleOnNavigateBack });
  }
